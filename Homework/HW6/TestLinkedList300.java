...
public class TestLinkedList300 {

	public static void main(String[ ] args) {
		String letters = "abcdefghijklmnopqrstuvwxyz";
		System.out.println("TestLinkedList300");
		LinkedList<Character> list1 = new LinkedList<Character>();
		LinkedList300<Character> list2 = new LinkedList300<Character>();
		...
		System.out.println("Java LinkedList: " + list1);
		System.out.println("CSC 300 LinkedList: " + list2);
		...
		char cs[] = {'a','z','b','y','c','x','d','w','e','v','f','u','g','t','h','s','i','r','j','q'}; //20
		...
		for (int i=0; i<list1.size(); i++) //if the indexes doesn't match it would output is wrong
